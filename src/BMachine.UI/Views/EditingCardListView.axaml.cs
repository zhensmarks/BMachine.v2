...
public partial class EditingCardListView : UserControl
{
    ...
    private void OnRootGridSizeChanged(object? sender, SizeChangedEventArgs e)
    {
        ...
        // Ensure parts are loaded (generated via x:Name)
        // Accessing named fields directly assumes they are generated by Avalonia source generators
        // If not, we use FindControl. 
        // We'll use FindControl for safety if fields aren't guaranteed to be in scope for this partial context without Design.
        ...
        if (commentPanel == null || mainContent == null) return; // Basic check
    ...
    private void UpdatePanelForMobile(Border? panel)
    {
        ...
        // Use AppBackgroundBrush from resources
